        ...
        children: [
          Container(
            ...
            child: langHoster.length >= 2
                ...
                children: Map.fromIterable(langHoster, key: (k) => k.id, value: (v) => Container(child: Text(v.language,softWrap: true,))),
            ...
            child: ListView.builder(
              ...
              itemBuilder: (_, index) {
               /* HosterLanguageManager manager = langHoster.where((element) => element.id == segmentControlValue).toList().first;*/
                return Container(); /*buildHostUi(manager.hosterManagerList[index].browserurl, manager.hosterManagerList[index].name);*/
              },
            ),
          )
        ],
